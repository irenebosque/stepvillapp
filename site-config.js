module.exports = {
  // App Info
  appstore_link         : "https://docs.google.com/document/d/1fT9geooeYns8GMdkfHT3BN3TfJnftHg62T25Dk6FmqI/edit?usp=sharing",                                  // Enter App Store URL.
  ...
  presskit_download_link: "https://docs.google.com/document/d/1e_yvanlOv7u3wWBMzPa6ktNm5cDkmlpI5VK78PkaXUg/edit",                                  // Enter a link to downloadable file or (e.g. public Dropbox link to a .zip file). 
  video_or_screenshot   : "screenshot",                                           // "screenshot" or "video"
  app_url               : "https://agalp.imedadel.me",                            // Domain of your website without path_prefix.
  path_prefix           : "/",                                                    // Prefixes all links. For cases when deployed to example.github.io/automatic-gatsbyjs-app-landing-page/.
  app_name              : "StepVillapp",
  app_price             : "Free",
  app_description       : "A magic world powered by your steps.",
  app_keywords          : ["steps", "game", "app", "motivation"],

  // Personal Info
  your_name              : "Irene Bosque",
  your_link              : "https://irenebosque.github.io",
  your_city              : "🇪🇸 Spain",
  email_address          : "stepvillapp@gmail.com",
  linkedin_username      : null,
  facebook_username      : null,
  instagram_username     : "ed_adel",
  twitter_username       : "stepvillapp",
  github_username        : "irenebosque",
  ...
  cover_overlay_color_rgba      : "rgba(184, 204, 197, 0.5)", //  "rgba(54, 59, 61, 0.8)",
